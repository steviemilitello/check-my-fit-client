...
const IndexEveningOutfits = (props) => {

    const [outfits, setOutfits] = useState(null)
    const { msgAlert } = props

    useEffect(() => {
        getTagOutfits("626844a16c8d870164be1820")
            .then(res => {
    ...
    return (
        <>
            <h3 style={{ textAlign: 'center', padding: '10px' }}>Evening Wear</h3>
...
export default IndexEveningOutfits