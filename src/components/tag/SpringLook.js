...
const IndexSpringLookOutfits = (props) => {

    const [outfits, setOutfits] = useState(null)
    const { msgAlert } = props

    useEffect(() => {
        getTagOutfits("62684451d7b7b8aa38d05671")
            .then(res => {
    ...
    return (
        <>
            <h3 style={{textAlign: 'center', padding: '10px'}}>Spring Looks</h3>
...
export default IndexSpringLookOutfits