...
import { getDateNightOutfits, getTagOutfits } from '../../api/tag'
...
const IndexDateNightOutfits = (props) => {

    const [outfits, setOutfits] = useState(null)
    const { msgAlert } = props

    useEffect(() => {
        getTagOutfits("6268443d39595b809ff5dc7d")
            .then(res => {
    ...
    return (
        <>
            <h3 style={{textAlign: 'center', padding: '10px'}}>Date Night</h3>
...
export default IndexDateNightOutfits