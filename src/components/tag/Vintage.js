...
const IndexVintageOutfits = (props) => {

    const [outfits, setOutfits] = useState(null)
    const { msgAlert } = props

    useEffect(() => {
        getTagOutfits("62684388d744f0c94e08d96e")
            .then(res => {
    ...
    return (
        <>
            <h3 style={{ textAlign: 'center', padding: '10px' }}>Vintage</h3>
...
export default IndexVintageOutfits