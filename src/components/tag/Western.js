...
const IndexWesternOutfits = (props) => {

    const [outfits, setOutfits] = useState(null)
    const { msgAlert } = props

    useEffect(() => {
        getTagOutfits("62684471019f634d3b1e1a4f")
            .then(res => {
    ...
    return (
        <>
            <h3 style={{textAlign: 'center', padding: '10px'}}>Western</h3>
...
export default IndexWesternOutfits